...
public class Livro {
    ...
    public Livro(Integer id, String titulo, String autor, Integer anoPublicacao, Integer quantidadeDisponivel,
                 LocalDate dataCadastro, String isbn, String editora) {
        this.id = id;
        this.titulo = titulo;
        this.autor = autor;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, livro.id) && Objects.equals(titulo, livro.titulo) && Objects.equals(autor, livro.autor)
                && Objects.equals(anoPublicacao, livro.anoPublicacao) && Objects.equals(quantidadeDisponivel, livro.quantidadeDisponivel)
                && Objects.equals(dataCadastro, livro.dataCadastro) && Objects.equals(isbn, livro.isbn) && Objects.equals(editora, livro.editora);
    }
